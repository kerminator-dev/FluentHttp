using FluentHTTPToolkit.Core.Builders.Interfaces;
using Newtonsoft.Json;
using System.Net;
using System.Text;

namespace FluentHTTPToolkit.Core.Builders.Implementation
{
    public class HttpWebRequestBuilder : IBuilder<WebRequest>
    {
        ...
        public HttpWebRequestBuilder(string address)
        {
        ...
        /// <returns></returns>
        public HttpWebRequestBuilder WithJsonBody<TRequestBody>(TRequestBody body)
        {
            _requestBody = body;
        ...
        /// <returns></returns>
        public HttpWebRequestBuilder WithHttpMethod(HttpMethod httpMethod)
        {
        ...
        /// <returns></returns>
        public HttpWebRequestBuilder WithHeader(string key, string value)
        {
        ...
        /// <returns></returns>
        public HttpWebRequestBuilder WithJwtAccessToken(string token)
        {
